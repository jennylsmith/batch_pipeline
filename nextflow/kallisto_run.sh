...
nextflow run -c ~/nextflow.config -work-dir $BASE_BUCKET/work \
    -with-report RBD_b12_report.html -cache TRUE -resume kallisto.nf \
    --sample_sheet ~/scripts/batch_pipeline/sample_sheets/RBD_batch1_batch2_sample_sheet.txt \
    --index $BASE_BUCKET/GRCh38.v29/gencode.v29_RepBase.v24.01.idx \
    --picard_out_dir $BASE_BUCKET/picard_fq2/ \
    --kallisto_out_dir $BASE_BUCKET/kallisto_out/Batch12/
    --skip_picard true
